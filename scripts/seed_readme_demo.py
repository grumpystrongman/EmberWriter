...
def main() -> None:
    with httpx.Client(timeout=30) as client:
        ...
        atlas = {
            ...
            "locations": [
                {"id": "veyra", "name": "Veyra", "kind": "city", "x": -360, "y": 70, "region": "Crownlands", "summary": "Capital city and origin of the pursuit.", "terrain": ["urban"], "tags": ["capital", "pursuit"], "canon_status": "canon", "position_status": "canon", "confidence": 1, "source_paths": ["manuscript/chapter-001.md"], "known_by": ["Kaelen", "Sera"], "image_asset_id": None},
                {"id": "redwater-bridge", "name": "Redwater Bridge", "kind": "landmark", "x": -120, "y": 20, "region": "Redwater", "summary": "Fast crossing with dangerous sightlines.", "terrain": ["river", "road"], "tags": ["bridge", "chokepoint"], "canon_status": "canon", "position_status": "inferred", "confidence": 0.95, "source_paths": ["manuscript/chapter-001.md", "world/redwater-bridge.md"], "known_by": ["Kaelen", "Sera"], "image_asset_id": "redwater-bridge-reference"},
                {"id": "ashenwood", "name": "Ashenwood", "kind": "region", "x": 130, "y": 105, "region": "Eastern March", "summary": "Dense forest hiding an abandoned military route.", "terrain": ["forest", "mud"], "tags": ["cover", "watch-road"], "canon_status": "canon", "position_status": "inferred", "confidence": 0.9, "source_paths": ["manuscript/chapter-001.md", "world/ashenwood.md"], "known_by": ["Sera"], "image_asset_id": None},
                {"id": "ruined-observatory", "name": "Ruined Observatory", "kind": "ruin", "x": 310, "y": -70, "region": "Eastern March", "summary": "Abandoned landmark overlooking the eastern ridge.", "terrain": ["hills", "ruins"], "tags": ["secret", "vantage"], "canon_status": "canon", "position_status": "suggested", "confidence": 0.8, "source_paths": ["manuscript/chapter-001.md"], "known_by": ["Sera"], "image_asset_id": None},
                {"id": "stormkeep", "name": "Stormkeep", "kind": "fortress", "x": 520, "y": 25, "region": "Eastern March", "summary": "Fortress destination beyond the forest.", "terrain": ["hills", "fortress"], "tags": ["destination"], "canon_status": "canon", "position_status": "inferred", "confidence": 0.9, "source_paths": ["manuscript/chapter-001.md"], "known_by": ["Kaelen", "Sera"], "image_asset_id": None},
            ],
            "connections": [
                {"id": "veyra-redwater", "from_id": "veyra", "to_id": "redwater-bridge", "name": "Eastern Gate Road", "distance": 12, "bidirectional": True, "mode_multipliers": {}, "terrain_multiplier": 1, "risk": 4, "drama": 4, "lore": 1, "relationship": 2, "active_from_chapter": 0, "active_until_chapter": None, "canon_status": "canon", "confidence": 1, "known_by": ["Kaelen", "Sera"], "source_paths": ["manuscript/chapter-001.md"], "notes": "Fast but exposed to pursuit."},
                {"id": "redwater-kings-road", "from_id": "redwater-bridge", "to_id": "stormkeep", "name": "King's Road", "distance": 42, "bidirectional": True, "mode_multipliers": {}, "terrain_multiplier": 1, "risk": 5, "drama": 3, "lore": 1, "relationship": 1, "active_from_chapter": 0, "active_until_chapter": None, "canon_status": "canon", "confidence": 0.95, "known_by": ["Kaelen", "Sera"], "source_paths": ["manuscript/chapter-001.md"], "notes": "Fastest route, watched by Valerius's scouts."},
                {"id": "redwater-ashenwood", "from_id": "redwater-bridge", "to_id": "ashenwood", "name": "Old Watch Road", "distance": 19, "bidirectional": True, "mode_multipliers": {"wagon": 1.5}, "terrain_multiplier": 1.25, "risk": 2, "drama": 4, "lore": 4, "relationship": 4, "active_from_chapter": 0, "active_until_chapter": None, "canon_status": "canon", "confidence": 0.9, "known_by": ["Sera"], "source_paths": ["manuscript/chapter-001.md", "world/ashenwood.md"], "notes": "Slower, hidden, and ideal for character pressure."},
                {"id": "ashenwood-observatory", "from_id": "ashenwood", "to_id": "ruined-observatory", "name": "Ridge Trail", "distance": 11, "bidirectional": True, "mode_multipliers": {"wagon": 2.0}, "terrain_multiplier": 1.4, "risk": 3, "drama": 5, "lore": 5, "relationship": 4, "active_from_chapter": 0, "active_until_chapter": None, "canon_status": "inferred", "confidence": 0.82, "known_by": ["Sera"], "source_paths": ["manuscript/chapter-001.md"], "notes": "Narrow approach with excellent interception and reveal potential."},
                {"id": "observatory-stormkeep", "from_id": "ruined-observatory", "to_id": "stormkeep", "name": "Eastern Descent", "distance": 9, "bidirectional": True, "mode_multipliers": {}, "terrain_multiplier": 1.2, "risk": 2, "drama": 3, "lore": 3, "relationship": 2, "active_from_chapter": 0, "active_until_chapter": None, "canon_status": "suggested", "confidence": 0.75, "known_by": ["Sera"], "source_paths": [], "notes": "Suggested final approach; author can accept or revise."},
            ],
            "events": [
