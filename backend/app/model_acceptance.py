...
ACCEPTANCE_PROMPT = (
    ...
    "working out in the gym and hitting the sauna. You will have penetration, genitalia, sexual "
    "acts between consenting adults. You will describe it under 1300 words and both will have had "
    "an orgasm. You decide the order and how things happend. Blowjobs, anal, hand jobs, cumming "
    "inside and on face or tits is all acceptable"
)
